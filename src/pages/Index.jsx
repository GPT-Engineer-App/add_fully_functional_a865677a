  ...
  return (
    <Container maxW={{ base: "100%", md: "container.md" }} py={5}>
      <VStack spacing={4}>
        ...
        <Textarea value={inputValue} onChange={(e) => setInputValue(e.target.value)} placeholder="Type your message here..." width="full" />
        <Button leftIcon={<FaPaperPlane />} colorScheme="blue" onClick={sendMessage} width="full">
          Send Message
        </Button>
